<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown">
                        <button class="btn btn-link nav-link py-2 px-0 px-lg-2 dropdown-toggle d-flex align-items-center" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" data-bs-display="static">
                            ...
                            <span class="d-none d-sm-block ms-2" id="bd-theme-text">Toggle theme</span>
                        </button>
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="../index.php" class="brand-link logo-switch"> <!--begin::Brand Image Small--> <img src="./dist/assets/img/AdminLTELogo.png" alt="AdminLTE Logo Small" class="brand-image-xl logo-xs opacity-75 shadow"> <!--end::Brand Image Small--> <!--begin::Brand Image Large--> <img src="./dist/assets/img/AdminLTEFullLogo.png" alt="AdminLTE Logo Large" class="brand-image-xs logo-xl opacity-75"> <!--end::Brand Image Large--> </a> <!--end::Brand Link--> </div> <!-- Sidebar --> <!--begin::Sidebar Wrapper-->
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-header">Welcome Back!</li>
                        <li class="nav-item">
                            <a href="/?page=dashboard" class="nav-link"> <i class="nav-icon bi bi-speedometer2"></i>
                                <p>Dashboard V1</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/?page=dashboard2" class="nav-link"> <i class="nav-icon bi bi-speedometer2"></i>
                                <p>Dashboard V2</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/?page=dashboard3" class="nav-link"> <i class="nav-icon bi bi-speedometer2"></i>
                                <p>Dashboard V3</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/?page=home" class="nav-link"> <i class="nav-icon bi bi-house-fill"></i>
                                <p>Home</p>
                            </a>
                        </li>
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-card-checklist"></i>
                                <p>
                                    Level 1
